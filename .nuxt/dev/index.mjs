...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getHeader, setHeader, readFormData, getResponseStatusText } from 'file://G:/newblog/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://G:/newblog/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://G:/newblog/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://G:/newblog/node_modules/ufo/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file://G:/newblog/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://G:/newblog/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://G:/newblog/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://G:/newblog/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://G:/newblog/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://G:/newblog/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://G:/newblog/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://G:/newblog/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://G:/newblog/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://G:/newblog/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://G:/newblog/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://G:/newblog/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://G:/newblog/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://G:/newblog/node_modules/unstorage/drivers/fs.mjs';
import unstorage_47drivers_47memory from 'file://G:/newblog/node_modules/unstorage/drivers/memory.mjs';
import { digest } from 'file://G:/newblog/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://G:/newblog/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://G:/newblog/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://G:/newblog/node_modules/youch-core/build/index.js';
import { Youch } from 'file://G:/newblog/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://G:/newblog/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://G:/newblog/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://G:/newblog/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://G:/newblog/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://G:/newblog/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"G:/newblog/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"G:/newblog","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"G:/newblog/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"G:/newblog/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"G:/newblog/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"G:/newblog/.data/kv"}));
...
const _TXLV4rBvqsYiKFUYas4nE2ajd4M1kbGvbTN66ecZKaY = (function(nitro) {
...
const _iS2Hx_aRY6b5luI5ZFAVScoHeBMFBXD6z47xxZowt8 = (nitroApp) => {
...
const plugins = [
  _TXLV4rBvqsYiKFUYas4nE2ajd4M1kbGvbTN66ecZKaY,
...
const _bMBjWp = eventHandler((event) => {
...
const getServerEntry = () => import('file://G:/newblog/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://G:/newblog/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_3FDB6u = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_RVhut9 = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_4LphD0 = () => Promise.resolve().then(function () { return ____path__get$1; });
const _lazy_aRVeR7 = () => Promise.resolve().then(function () { return image_post$1; });
const _lazy_SGBIuo = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/posts', handler: _lazy_3FDB6u, lazy: true, middleware: false, method: "get" },
  { route: '/api/posts', handler: _lazy_RVhut9, lazy: true, middleware: false, method: "post" },
  { route: '/api/r2/**:path', handler: _lazy_4LphD0, lazy: true, middleware: false, method: "get" },
  { route: '/api/upload/image', handler: _lazy_aRVeR7, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_SGBIuo, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SGBIuo, lazy: true, middleware: false, method: undefined }
];
